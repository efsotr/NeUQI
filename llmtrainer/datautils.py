...
def get_loaders(
    ...
    Args:
        ...
        tokenizer_path (str, optional): The path to the pretrained model weights or full model name.
    ...
    if name.lower() == "none":
        ...
        if isinstance(tokenizer_path, str):
            tokenizer = AutoTokenizer.from_pretrained(
                tokenizer_path, use_fast=use_fast_tokenizer, trust_remote_code=trust_remote_code
            )
        else:
